    ...
    , ui(new Ui::MainWindow)
{
    ...
    QPixmap pix("C:/Users/2077s/Desktop/akshat folder/Kalam/Images/team-logo.png");
    ui->logo->setPixmap(pix.scaled(95,100,Qt::KeepAspectRatio));

    QPixmap pixclr("C:/Users/2077s/Desktop/akshat folder/Kalam/Images/color-bar.png");
    ui->colorbar->setPixmap(pixclr.scaled(250,250,Qt::KeepAspectRatio));
...
{
    QFile d("C:/Users/2077s/Desktop/akshat folder/Kalam/read.csv");
    qDebug() << "CSV printing";
...
void MainWindow::plotSec()
{
    if(loop1 < plotTest.size()) {
        buffer_split = plotTest[loop1++].split("\r\n");
        element = buffer_split[0].split(",");
        sensordata = buffer_split[0].split(",1077,");
        setPrecision();
        updateGraphArray(element);
...
void MainWindow::updateContainerLabel(QStringList element) {
    ...
    ui->rawdata->setText(buffer_split[0]);
}

void MainWindow::updatePayloadLabel(QStringList element)
{
    // 21,23,24,25,p(23)
   ui->SPVoltage->setText(element[22]);
    ui->SPALTITUDE->setText(element[20]);
    ui->SPTEMPERATURE->setText(element[21]);
    ui->SPGYROR->setText(element[23]);
    ui->SPGYROP->setText(element[24]);
    ui->SPGYROY->setText(element[25]);
    ui->SPACCR->setText(element[26]);
    ui->SPACCP->setText(element[27]);
    ui->SPACCY->setText(element[28]);
...
QFile file("C:/Users/2077s/Desktop/akshat folder/Kalam/write.csv");
QFile Cfile("C:/Users/2077s/Desktop/akshat folder/Kalam/Flight_1077_C.csv");
QFile Pfile("C:/Users/2077s/Desktop/akshat folder/Kalam/Flight_1077_T.csv");
